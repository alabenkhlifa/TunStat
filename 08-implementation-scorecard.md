...
```mermaid
flowchart TD
    A["Cabinet Economic Delivery Committee"] --> B["Finance and debt"]
    A --> C["Electricity and water"]
    A --> D["Investment and projects"]
    A --> E["Jobs and social protection"]
    B --> F["Independent fiscal assessment"]
    C --> G["Electricity regulator / regulator-designate"]
    D --> H["Project sponsors and procurement authorities"]
    E --> I["Social registry and local service points"]
    F --> J["Public monthly dashboard"]
    G --> J
    H --> J
    I --> J
```
